...
class PlayState extends MusicBeatState
{
	...
	var city:BGSprite;
	var pizzaria:BGSprite;
	var place:BGSprite;
	var montero:BGSprite;
	...
	override public function create()
	{
		...
		if(SONG.stage == null || SONG.stage.length < 1) {
			switch (songName)
			{
				case 'mashions' | 'sketches' | 'over-copied':
				    curStage = 'stage-city';
				case 'montero':
					curStage = 'stage-tree';
				case 'trippin' | 'skip-hop' | 'corny':
					curStage = 'izzy-stage';
				case 'did-you-know':
					curStage = 'pizzeria';
				default:
		...
		/*	case 'stage-city':
			    var city:BGSprite = new BGSprite('nando/ATROPOLISBG', 185, -160, 1, 1);
			    city.scale.set(1, 1);
				add(city);
			case 'tree':
				var montero:BGSprite = new BGSprite('montero/MONTEROBG', -100, -35, 1, 1);
				montero.scale.set(0.8, 0.8);
				add(montero);
			case 'izzy-stage':
				var place:BGSprite = new BGSprite('izzy/izzy-stage', 0, 0, 1, 1);
				place.scale.set(0.26, 0.26);
				add(place);
			case 'pizzaria':
				var pizzaria:BGSprite = new BGSprite('pizza/PIZZABG', -420, -130, 1, 1);
				pizzaria.scale.set(0.2, 0.2);
				add(pizzaria); */
		}
